...
<html lang="en">
  <head>
    ...
    <title>Customer  Paid Invoice Detail</title>
  </head>
  <body>
	  	...
	  	<div class="row">
	  		<div class="col-md-12">
	  			...
	  			<table width="100%">
			   	...
			   	<h2  style="text-align: center;">Customer Paid Invoice Detail </h2>
			   	...
			   	<div>
			   		<h3>Invoice Number # {{$payment['invoice']['invoice_number']}}</h3>
  		...
  		<div class="row">
	 		 ...
	 		 <tr>
				...
				@endforeach
					...
					<tr>
					<td colspan="3" ><strong> 
					 Total Paid Amount</strong></td>
					<td colspan="4" style="text-align:center;" > {{$payment->paid_amount}}</td>
				</tr>
			<tr>
					<td colspan="6" ><strong> 
