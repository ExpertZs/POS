...
Route::get('customer-credit-invoice-detail/{invoice_id}', [App\Http\Controllers\ReportController::class, 'customer_credit_invoice_detail'])->name('customer-credit-invoice-detail/{invoice_id}');

Route::get('customer-paid-invoice', [App\Http\Controllers\ReportController::class, 'customer_paid_invoice'])->name('customer-paid-invoice');
Route::get('customer-paid-invoice-report', [App\Http\Controllers\ReportController::class, 'customer_credit_paid_report'])->name('customer-paid-invoice-report');
Route::get('customers-paid-report/{invoice_id}', [App\Http\Controllers\ReportController::class, 'customer_paid_invoice_detail'])->name('customers-paid-report/{invoice_id}');

Route::get('customer-wise-credit-paid', [App\Http\Controllers\ReportController::class, 'customer_wise_credit_paid'])->name('customer-wise-credit-paid');
Route::get('customer-wise-credit', [App\Http\Controllers\ReportController::class, 'customer_wise_credit'])->name('customer-wise-credit');
Route::get('customer-wise-paid', [App\Http\Controllers\ReportController::class, 'customer_wise_paid'])->name('customer-wise-paid');


Route::get('invoice-wise-delivery-stock', [App\Http\Controllers\ReportController::class, 'invoice_wise_delivery_stock'])->name('invoice-wise-delivery-stock');

Route::get('report-for-delivery', [App\Http\Controllers\ReportController::class, 'report_for_delivery'])->name('report-for-delivery');
Route::get('report-for-warehouse', [App\Http\Controllers\ReportController::class, 'report_for_warehouse'])->name('report-for-warehouse');
